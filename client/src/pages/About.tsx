      ...
      <section className="section bg-paper-2">
        <div className="container">
          ...
          <p className="lead max-w-2xl">
            Trux Insurance Services places commercial trucking and fleet coverage across 22 states. We've built our agency around one industry, one set of markets, and one promise: stand behind the program at claim time.
          </p>
        </div>
      </section>
