...
const operationData: Record<string, OperationData> = {
  ...
  "large-fleets": {
    ...
    faq: [
      { question: "Can you handle multi-state fleet programs?", answer: "Yes. We place coverage across all 21 states where we're licensed and coordinate with partner agencies for states outside our footprint. Your fleet gets one cohesive program regardless of where trucks are domiciled." },
